	...
	<div class="container-fluid">
		<div class="table-responsive ">
			<table class="table table-hover table-sm">
				<thead
					style="background-color: #333333; color: white; font-size: 18px;">
					<tr>
						<th>Image</th>
						<th>ProductId</th>
						<th>Name</th>
						...
						<td>
							<form method="post">
								<button type="submit"
									...
									class="btn btn-primary" style="background-color: #1E90FF; color: #FFFFFF; border: #1C7ED6;">Update</button>
							</form>
						</td>
						<td>
							<form method="post">
								<button type="submit"
									...
									class="btn btn-danger" style="background-color: #FF5733; color: #FFFFFF; border: #E04127;">Remove</button>
							</form>
						</td>
