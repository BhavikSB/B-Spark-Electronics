			...
			<form action="./UpdateProductSrv" method="post"
				...
				<div class="row text-center">
					<div class="col-md-6" style="margin-bottom: 2px;">
						<button formaction="adminViewProduct.jsp" class="btn btn-danger" class="btn btn-info" style="color: #FFFFFF; border: #1C7ED6; width:100%">Cancel</button>
					</div>
					<div class="col-md-6">
						<button type="submit" class="btn btn-success" style="background-color: #1E90FF; color: #FFFFFF; border: #1C7ED6; width:100%">Update
							Product</button>
					</div>
				</div>
			</form>
