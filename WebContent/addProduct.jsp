			...
			<form action="./AddProductSrv" method="post"
				...
				<div class="row">
					<div class="col-md-6 text-center" style="margin-bottom: 2px;">
						<button type="reset" class="btn btn-danger" style="width: 100%;border:white;font-weight:bold;font-size:medium;">Reset</button>
					</div>
					<div class="col-md-6 text-center">
						<button type="submit" class="btn btn-success" style="background-color: #333333; width: 100%;border:white;font-weight:bold;font-size:medium;">Add Product</button>
					</div>
				</div>
			</form>
		</div>
