...
<br/>
	<div class="container bg-secondary" style="background-color: #FFFFFF;">
		<div class="row">
			<div class="col">
				<nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4">
					<ol class="breadcrumb mb-0" style="background-color: #333333 !important;">
						<li class="breadcrumb-item"><a href="index.jsp" style="color:#ffffff !important;">Home</a></li>
						<li class="breadcrumb-item"><a href="userProfile.jsp" style="color:#ffffff !important;">User
								Profile</a></li>
					</ol>
				</nav>
			</div>
				...
				<div class="card mb-4 mb-lg-0">
					<div class="card-body p-0">
						<ul class="list-group list-group-flush rounded-3">
							...
							<li
								class="text-center list-group-item d-flex justify-content-between align-items-center p-2">
								<h1>My Profile</h1>
							</li>
						</ul>
					</div>
