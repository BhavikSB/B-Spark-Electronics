...
<%@ page import="com.bhavik.service.impl.*,com.bhavik.service.*"%>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #333333; color: white; padding: 5px;">
		<h2>Welcome to B-Spark Electronics</h2>
		<h6>Your one-stop shop for cutting-edge electronic products and solutions.</h6>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>B-Spark Electronics</a>
			</div>
