...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "bhavik131204@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to B-Spark Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with B-Spark Electronics.<br>"
					...
					+ "<span class='greenText'>BS139</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
